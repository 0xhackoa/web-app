...
export default function Play() {
  ...
  useEffect(() => {
    ...
    deserialize(anonAadhaarProofs[Object.keys(anonAadhaarProofs).length - 1].pcd).then((result) => {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      {!eligibleUser ? <h1>User must be above 18 to place a bet!</h1> : <SwimmingRace />}
    </main>
  );
}
