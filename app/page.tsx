...
import ProveAge  from "@/components/ProveAge";
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="text-5xl">
        <h1 className="pb-5">Play a Bit</h1>
      </div>
      ...
      <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
        <div className="absolute top-0 left-0 right-0 p-4 text-center bg-background/80 backdrop-blur-sm z-9">
          <h2 className="text-lg font-palanquin">Bitcoin based cross-chain betting platform</h2>
        </div>
